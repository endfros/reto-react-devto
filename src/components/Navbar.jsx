      ...
      <section className="desktop-navbar">
        <section className="desktop-navbar__left">
          <button
            ...
            className="desktop-navbar__left__hamburgerIcon"
          >
            {sidebarOpen ? "" : " "}
            <HamburgerIcon />
          </button>
          <div
            className={`desktop-navbar__left__sidebarBackground ${
              sidebarOpen ? " showSidebar" : ""
            }`}
          >
            <section
              className={`desktop-navbar__left__sidebar ${
                sidebarOpen ? " showSidebar" : ""
              }`}
            >
        ...
        <section className="desktop-navbar__actions">
          ...
          {props.token && (
            <button
              className="desktop-navbar__actions__create-account"

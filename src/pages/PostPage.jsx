    ...
    <DefaultLayout>
      <div className="post-layout">
        <aside className="aside-left">
          <button className="post__aside-icon">
            <LikeIcon />
          </button>
        ...
        <article className="post">
          ...
          <section>
            ...
            <section className="post__content">{post.body}</section>
            <section className="post__comments">
              ...
              >
                <input
                  name="text"
                  type="text"
                  className="post__comments__form--content"
                />
                <input
                  type="submit"
                  className="card-profile__button"
                  value="Post comment"
                />
              </form>
            </section>
        ...
        <aside className="aside-right">
          <section className="card">
            <div className="card-profile text-bg-white">
              ...
              <div className="">
                <button type="button" className="card-profile__button">
                  Follow
                </button>
              </div>
